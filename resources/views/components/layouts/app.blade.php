...
<head>
    ...
    <!-- Fonts -->
    <link wire:ignore rel="preconnect" href="https://fonts.bunny.net">
    <link wire:ignore href="https://fonts.bunny.net/css?family=figtree:400,600&display=swap" rel="stylesheet" />
    <link wire:ignore href="{{ asset('img/favicon.ico') }}" rel="icon">

    <!-- Google Web Fonts -->
    <link wire:ignore rel="preconnect" href="https://fonts.googleapis.com">
    <link wire:ignore rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link wire:ignore
    ...
    <link wire:ignore href="{{ asset('css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Template Stylesheet -->
    <link wire:ignore href="{{ asset('css/style.css') }}" rel="stylesheet">
    @livewireStyles
...
<body class="bg-slate-100">
    ...
    <!-- Include Swiper JS -->
    <script wire:ignore src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <!-- Your custom main.js -->
    <script wire:ignore src="/js/main.js"></script>
</body>
