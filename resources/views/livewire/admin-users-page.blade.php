        ...
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <table class="min-w-full divide-y divide-gray-300">
                    <thead>
                        <tr>
                            <a href="/admin/add/users" wire:navigate>
                                <button
                            ...
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Nummer
                            </th>
                            </th>
                    ...
                    <tbody class="divide-y divide-orange-100 bg-white">
                        @foreach($users as $user)
                            ...
                            <tr class="hover:bg-[#ffe094] transition">
                                ...
                                <td
                                    class="relative whitespace-nowrap py-5 pl-3 pr-4 text-center text-sm font-medium sm:pr-0 mr-4">
