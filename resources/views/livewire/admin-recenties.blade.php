    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        @else
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider flex flex-col items-start">
                            <span>Selecteer welke ai moet analyseren.</span>
                            <button class="hover:text-gray-400 text-gray-700 transition border border-white hover:!border-gray-400 rounded-full px-2" wire:click.prevent="toggleSelectAll">Selecteer alles</button>
                        </th>
        ...
        @endif
        <span wire:stream="AIGenerated"><ul class="list-disc">{!! $AIGenerated !!}</ul></span>
    </div>
</div>
