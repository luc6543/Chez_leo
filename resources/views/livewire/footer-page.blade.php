        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="/over-ons" wire:navigate>Over Ons</a>
                    <a class="btn btn-link" href="/#Reserveer" wire:navigate>Reserveren</a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@chezleo.nl</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <h5 class="text-light fw-normal">Maandag - Dinsdag</h5>
                    <p>Gesloten</p>
                    <h5 class="text-light fw-normal">Woensdag</h5>
                    <p>17-22 uur (alleen diner) </p>
                    <h5 class="text-light fw-normal">Donderdag</h5>
                    <p>12-22 uur</p>
                    <h5 class="text-light fw-normal">Vrijdag t/m Zondag</h5>
                    <p>12-23 uur</p>
                </div>
                <div class="col-lg-3 col-md-6">
