<div class="mt-20 p-4 flex flex-col lg:flex-row gap-2 lg:gap-10 items-center lg:items-stat lg:justify-center">
    ...
    <div class="bg-white flex flex-col w-3/4 lg:w-fit gap-5 p-4 bg-no-repeat bg-cover shadow bg-[url('https://img.freepik.com/free-photo/white-crumpled-paper-background-simple-diy-craft_53876-128183.jpg?semt=ais_hybrid')]">
        <div>
