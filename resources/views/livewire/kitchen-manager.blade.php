<div class="mt-28 bg-white mb-16">
    <div class="ml-6 flex justify-center">
        <div class="flex space-x-1 rounded-lg bg-slate-100 p-0.5">
            <button wire:click="changeMode('kitchen')" class="flex items-center rounded-md py-[0.4375rem] pl-2 pr-2 text-sm font-semibold lg:pr-3 @if($mode == 'kitchen') bg-white @endif shadow" id="headlessui-tabs-tab-:r8q:" role="tab" type="button" aria-selected="true" tabindex="0">
